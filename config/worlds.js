...
export const WORLDS = {
  ...
  "sunlit-palace-gardens": {
    ...
    // Entry view turned live with the user: -2.03 (facing the facade) -> 1.11 (180, garden
    // ahead) -> 2.68 (a further 90 in the same direction). Spawn courtyard unchanged; artwork
    // stops and companion slots derive from spawn+yaw, so they swing round with the view.
    profile: { spawn: { x: -9.5, z: 15.5 }, groundY: 3.0, bounds: { minX: -75.29, maxX: 68.24, minZ: 1.12, maxZ: 82.68 }, yaw: 2.68, cameraFar: 400 },
    enclosed: false,
    recommended: false,
  },
};
