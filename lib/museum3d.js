...
export class Museum3D {
  ...
  placeArtworksInWorld(artworks) {
    ...
    for (let i = 0; i < n; i += 1) {
      ...
      const panel = new THREE.Mesh(new THREE.BoxGeometry(1.8, 2.5, 0.06), new THREE.MeshBasicMaterial({ color: 0xffffff, transparent: true, opacity: 0.2, depthWrite: false, toneMapped: false, side: THREE.DoubleSide }));
      ...
      const frame = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 0.05), new THREE.MeshBasicMaterial({ color: 0xf0f2f4, toneMapped: false }));
      ...
      painting.position.set(0, 1.5, 0.12);
